    ...
    if (empty($first_name) || empty($last_name) || empty($phone)) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            if (mysqli_query($conn, $update_sql)) {
                ...
                $refresh_sql = "SELECT * FROM admins WHERE id = $admin_id LIMIT 1";
...
<head>
    ...
    <title>تعديل ملف الأدمن - أثر</title>
...
<main class="home-main">
    <div class="auth-card request-form-card">
        ...
        <p class="auth-subtitle">يمكنك تعديل بيانات الأدمن من هنا</p>
        ...
        <form method="POST" action="" class="auth-form">
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" value="<?php echo htmlspecialchars($admin["email"]); ?>" disabled>
            </div>
            ...
            <div class="details-actions" style="margin-top: 10px;">
                <a href="admin-profile.php" class="secondary-btn details-btn">العودة إلى الملف الشخصي</a>
